...
export default function TechLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await loginAsTechnician(tech_id, password);
    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-accent flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-foreground">Technician Login</h2>
          <p className="text-muted-foreground mt-2">Access your service requests and manage bookings</p>
        </div>
